...
# GET A BUNCH OF HYPERPARAMETERS

for d in range(draws):
    hyperparameters.append(np.random.randint(100,2000))

for params in hyperparameters:
    print('Param : ' + str(params))
    print(train_error_storage)
    print(test_error_storage)
    train_errors = []
    test_errors = []
    # EVALUATE AND TRAIN THE NET
    #############################################################
    net = SecondNet(M=params)
    # examine net
    ...
    train_error_storage.append(train_errors)
    test_error_storage.append(test_errors)
